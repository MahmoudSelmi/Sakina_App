class SurahInfo {
  ...
  const SurahInfo(this.number, this.arabicName, this.englishName);
}
...
class SurahData {
  ...
  static const List<SurahInfo> all = [
    ...
    SurahInfo(3, 'آل عمران', 'Aal-Imran'),
    SurahInfo(4, 'النساء', 'An-Nisa'),
    SurahInfo(5, 'المائدة', 'Al-Maidah'),
    SurahInfo(6, 'الأنعام', 'Al-Anam'),
    SurahInfo(7, 'الأعراف', 'Al-Araf'),
    ...
    SurahInfo(23, 'المؤمنون', 'Al-Muminun'),
    SurahInfo(24, 'النور', 'An-Nur'),
    SurahInfo(25, 'الفرقان', 'Al-Furqan'),
    SurahInfo(26, 'الشعراء', 'Ash-Shuara'),
    ...
    SurahInfo(56, 'الواقعة', 'Al-Waqiah'),
    ...
    SurahInfo(61, 'الصف', 'As-Saf'),
    SurahInfo(62, 'الجمعة', 'Al-Jumuah'),
    ...
    SurahInfo(70, 'المعارج', 'Al-Maarij'),
    ...
    SurahInfo(79, 'النازعات', 'An-Naziat'),
  ...
  static SurahInfo byNumber(int number) => all[number - 1];
}
